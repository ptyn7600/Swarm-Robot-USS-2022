...
if __name__ == "__main__":
    ...
    plt.savefig('D:\\Research\\Swarm-Robot-USS-2022\\Data\\IR\\Distribution\\new\\images\\leastSquareMethod-deleted6070\\std_v2\\3D_overall_look')
    # plt.show()
    ...
    distance = np.linspace(4, 21, num=200)
    f = function2D(distance, np.array([0]), k1, a2, b2, c2)
    plt.plot(distance, f)
    ...
    # plt.savefig('D:\\Research\\Swarm-Robot-USS-2022\\Data\\IR\\Distribution\\new\\images\\leastSquareMethod-deleted6070\\std_v2\\0degree')
    plt.show()
